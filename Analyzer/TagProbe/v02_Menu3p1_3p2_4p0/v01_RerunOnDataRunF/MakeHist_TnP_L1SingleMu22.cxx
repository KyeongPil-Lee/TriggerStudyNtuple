...
void Setup( HistProducer* producer, TString dataType )
{
	...
	else if( dataType == "Menu3p2" )
	{
		...
		producer->AddDataPath( dataPath+"/92X/TSntuple_v20171208_SingleMuon_Run2017Fv1_305832_to_305862_GoldenJSON_Menu3p2/ntuple_*.root");
	}
	else if( dataType == "Menu4p0" )
	{
		producer->SetOutputFileName("ROOTFile_MakeHist_TnP_L1SingleMu22_Menu4p0.root" );

		producer->AddDataPath( dataPath+"/92X/TSntuple_v20171208_SingleMuon_Run2017Fv1_305832_to_305862_GoldenJSON_Menu4p0/ntuple_*.root");
	}
}